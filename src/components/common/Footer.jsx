...
const Footer = () => {
    return (
        <footer className='colorPrimario' data-bs-theme="success">
            <section className='p-4 container'>
                <Row>
                    ...
                    <Col md={4} className='d-flex flex-column py-3 py-md-0'>
                        <h5 className='textoFooter'>Navegación</h5>
                    ...
                    <Col md={4}>
                        <article className='mb-3'>
                            <h5 className='mb-0 textoFooter'>Redes Sociales:</h5>
                            <div className='d-flex gap-3'>
                                <Link to={'/instagram'} className="fs-4 link-success"><Instagram></Instagram></Link>
                        ...
                        <article>
                            <h5 className='textoFooter'>Descarga Nuestra App:</h5>
            ...
            <section className="text-center py-1 text-light footerInferior">
                <p className='m-0 textoFooterInferior'>PlayZone 2025 &copy; Todos los derechos reservados</p>
            </section>
        </footer>
    );
};
