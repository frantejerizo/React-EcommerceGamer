...
const Footer = () => {
  return (
    <footer data-bs-theme="success">
      <section className="p-4 bg-blanco">
        <Row>
          <Col
            md={4}
            className="d-flex justify-content-center align-items-center"
          >
            <img src={logo} alt="logo footer ecommerce gamer" width="80px" />
          </Col>
          <Col md={4} className="d-flex flex-column py-3 py-md-0">
            <h5 className="textoFooter bg-azul">Navegación</h5>
            <Link
              to={"/"}
              className="lead link-success link-underline-opacity-0 link-underline-opacity-100-hover "
            >
              Inicio
            </Link>
            <Link
          ...
          <Col md={4}>
            <article className="mb-3">
              ...
              <div className="d-flex gap-3">
                <Link to={"/instagram"} className="fs-4 link-success">
                  <Instagram></Instagram>
                </Link>
                <Link to={"/twitter"} className="fs-4 link-success">
                  <Twitter></Twitter>
                </Link>
                <Link to={"/facebook"} className="fs-4 link-success">
                  <Facebook></Facebook>
                </Link>
              </div>
            </article>
